...
#~~ run power analysis - part 1 - effect sizes 0.001-0.025 - run on HPC
...
#~~ run power analysis - part 2 - effect sizes 0.026-0.050 - run on HPC
...
#~~ PAC power analysis graph - figure s5
